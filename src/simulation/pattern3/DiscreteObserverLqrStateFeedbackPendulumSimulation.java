...
import model.pattern3.DiscreteObserverLQRStateFeedbackPendulum;

/**
 * 倒立振子の(LQR最適制御に基づく状態フィードバック+離散時間オブザーバ)による安定化制御のシミュレーションを実行するクラスです
 * 
 * @author arabian9ts
 *
 */
public class DiscreteObserverLqrStateFeedbackPendulumSimulation {
	/**
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		SystemOperator system = DiscreteObserverLQRStateFeedbackPendulum.getInstance();
